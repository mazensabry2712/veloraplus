...
Phase 8 — Company Dashboard is in progress. The Dashboard Shell is implemented. The 8.2 Company Foundation backend mutation layer is implemented across Company Profile, Locations, Tenant Settings, Staff, Customers, Users/Memberships, and Custom Roles/Permissions. The remaining presentation/listing work belongs to the later Dashboard UI pass. The next backend delivery is 8.3 Booking workspace.
